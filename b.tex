...
From Figure~\ref {fig_fa_sn}, we conclude that MIP is stable for every 
...
\begin{figure}[!htbp]
  ...
  \begin{subfigure}{0.40\textwidth}
    ...
    \caption{Zoom emphasizing triangular, rectangular, and hexagonal cells}
  \end{subfigure}
...
Figure~\ref {mat_amr} shows the material zoning and the mesh used. Material properties 
are given in Table~\ref {prop_amr} and their spatial distribution is given in Figure~\ref {mat_amr}. 
