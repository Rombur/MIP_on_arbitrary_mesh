...
and that the maximum spectral radius shows little sensitivity the aspect ratio.
\begin{figure}[!htbp]
  \centering
...
\textcolor{green}{Il n'y a qu'une cellule sur le coin inferieur gauche qui plonge un peu
  plus que les autres. Je ne sais pas si c'est parce que les cellules font
  qu'il y legerement plus de fuite ou a cause du critere de convergence. Je ne
pense pas que ce soit significatif.}
