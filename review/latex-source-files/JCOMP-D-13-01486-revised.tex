...
$\Sigma_s=0.99999cm^{-1}$) of dimension $100cm \times 100cm$ isused. An isotropic incoming flux of intensity
...
Figure~\ref {fig_no_dsa}.
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{no_dsa}
