...
We were limited to convex cells because our transport sweep algorithm did not allow for cycles in the graph of the sweep. We added Reference 32 where PWLD was employed to carry out Sn transport sweeps for non-convex polygonal cells. % The DSA solver works on \textcolor{red}{arbitrary} distorted cells.
