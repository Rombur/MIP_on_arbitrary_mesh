...
Once aggregation is done, a tentative prolongator matrix, $\bs{\tilde{P}}_k$ 
...
\subsection{AGMG}
Unlike ML, the prolongator in AGMG is not smoothed; this results in a
cheaper setup and a decrease in memory requirements \cite{agmg2}. However, as
explained previously, the scheme could be less robust. To counteract this weakness, the
aggregation scheme is more complicated. Coarsening algorithms that control
...
number rather than the coarsening speed is a much more interesting feature. By 
...
aggregates the variables two by to to allow a simple computation of the aggregate 
