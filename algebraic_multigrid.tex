...
An algebraic multigrid method to precondition the Krylov solver for the 
even-parity finite element-spherical harmonics (FE-$P_N$) method; see, for instance,
\cite{amg_pn}. \textcolor{red}{There}, the use of AMG  as a 
...
A simple way to create the aggregates would be to try exhaustively all of the possible 
...
computational cost of the method. \textcolor{red}{so what is used?}
