\begin{abstract}
  ...
  %is extended to the Piece-Wise Linear Discontinuous (PWLD) finite elements.}
	In this paper, a Diffusion Synthetic Acceleration (DSA) technique for \sn radiation transport
	is developed for on arbitrary polygonal grids using a Piece-Wise Linear Discontinuous (PWLD) 
	finite element approximation.
%	
  The discretization of the DSA equations uses an Interior Penalty technique, as in classically derived from a standard
