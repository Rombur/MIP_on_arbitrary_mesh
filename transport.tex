...
the cells, \textcolor{red}{thus requiring only to solve a small linear system of equations,
...
polygonal grid. However, from a simple code implementation perspective, the computation of
the elementary matrices of a polygonal cell is greatly simplified by looping over its sub-cells. 
